  ...
  return (
    ...
    >
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8 flex flex-col lg:flex-row gap-8 min-h-0">
        <div className="w-full lg:w-3/5 flex flex-col gap-4 min-h-0 h-[calc(100vh-14rem)] min-h-[900px]">
          <div
        ...
        <div className="w-full lg:w-2/5 flex flex-col gap-4 anim-fade-in anim-delay-1 min-h-0 h-[calc(100vh-14rem)] min-h-[900px]">
          <RightPanel />
        </div>
      </main>
    </div>
